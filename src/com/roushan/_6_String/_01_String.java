...
public class _01_String {
    public static void main(String[] args) {
        ...
        a = "Rocky";
        System.out.println(a);   //new object for an is created in job pool.
        System.out.println(b);   //we can see b will remain the same.
        ...
        String p3 = "Bankai";
        String p4 = new String("Bankai"); // this will create Bankai in a different object.From above.
